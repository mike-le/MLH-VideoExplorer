  ...
  function doSearch(e) {
    ...
    fetch(`/search?query=${query}`).then(function (response) {
      ...
      data.results.forEach(function (entry) {
        innerHtml = innerHtml + '<div class="tile"><div class="title">' + entry.name + '</div><div style="float:left"><img class="thumbnail" src="/thumbnail?id=' + entry.thumbnailId + '&videoId=' + entry.thumbnailVideoId + '" /></div>';
